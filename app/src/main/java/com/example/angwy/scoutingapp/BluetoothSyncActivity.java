...
import com.example.angwy.scoutingapp.BluetoothFilePusher.*;
...
public class BluetoothSyncActivity extends BaseActivity {
    ...
    protected void sendButton_Clicked(View v) {
        ...
        connection.send(com.example.angwy.scoutingapp.matchscouting.FinishMatchFragment.getScoutingDataStorageDir());
    }
