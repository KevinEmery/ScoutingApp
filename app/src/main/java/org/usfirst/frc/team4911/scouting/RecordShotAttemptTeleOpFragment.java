...
public class RecordShotAttemptTeleOpFragment extends Fragment {
    ...
    public static RecordShotAttemptTeleOpFragment newInstance(String param1, String param2) {
        RecordShotAttemptTeleOpFragment fragment = new RecordShotAttemptTeleOpFragment();
