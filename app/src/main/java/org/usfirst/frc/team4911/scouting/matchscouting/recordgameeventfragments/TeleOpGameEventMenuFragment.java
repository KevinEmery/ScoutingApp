 ...
 */
public class TeleOpGameEventMenuFragment extends DialogFragment implements OnItemClickListener {

    private String[] MATCH_EVENTS = new String[] { "Climbing" };
    private ListView mListView;

    public TeleOpGameEventMenuFragment() {
        // Required empty public constructor
    }

    public static TeleOpGameEventMenuFragment newInstance() {
        return new TeleOpGameEventMenuFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_teleop_game_event_menu, container, false);
        mListView = (ListView) view.findViewById(R.id.teleop_match_event_list_view);
        return view;
    }
